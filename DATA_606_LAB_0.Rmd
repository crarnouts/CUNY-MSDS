---
title: "DATA 606 Lab 0 - Corey Arnouts - Introduction to R and RStudio"
...
-   What years are included in this data set? What are the dimensions of the 
    ...
    - There  is every year between 1940 and 2002
    - The dimesnions are 3 columns and 63 rows
...
-   How do these counts compare to Arbuthnot's? Are they on a similar scale?
  -Both dataset have the same 3 cloumns but the present dataset has 63 rows while the arbuthnot dataset has 82 rows
```{r}
dim(present)
dim(arbuthnot)
```
